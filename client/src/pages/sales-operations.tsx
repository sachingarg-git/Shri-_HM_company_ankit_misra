  ...
  const handleDownloadSalesOrderPDF = async (salesOrder: any) => {
    try {
      ...
      const invoiceData = {
        ...
        paymentTerms: quotation?.paymentTerms ? `${quotation.paymentTerms} Days Credit. Interest will be charged Day 1st Of Billing @18%P.A` : (salesOrder.paymentTerms || 'ADVANCE'),
