    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-2">
          ...
          <TabsTrigger value="ta-reports">TA Reports</TabsTrigger>
        </TabsList>
      ...
      <Dialog open={isClientDetailsOpen} onOpenChange={setIsClientDetailsOpen}>
        ...
        {/* TA Reports Tab */}
        <TabsContent value="ta-reports" className="space-y-6">
          <TAReportsSection />
        </TabsContent>
...
function TAReportsSection() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">TA Expense Reports</h2>
